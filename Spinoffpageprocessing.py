...
def Packagefor_3dlibclass(input1,inputcomp,Pathdata,listConfig):
       ...
       os.system("echo 'Rkj3548123' | sudo -S mkdir"+"\t"+EXTRACT+"/"+inputcomp+"/"+inputcomp+"M"+"Pinsfunc")
       os.system("echo 'Rkj3548123' | sudo -S chmod -R 777"+"\t"+EXTRACT+"/"+inputcomp+"/"+inputcomp+"M"+"Pinsfunc")  
